...
<?php /* translators: %1$s: Site title, %2$s: Username, %3$s: My account link */ ?>
	...
	<p><?php printf( __( 'Thanks for creating an account on the WaterUps from DownUnder website.', 'woocommerce' ) ); ?></p>
	<p><?php printf( __( 'Your username is: %1$s', 'woocommerce' ), '<strong>' . esc_html( $user_login ) . '</strong>' ); ?></p>
