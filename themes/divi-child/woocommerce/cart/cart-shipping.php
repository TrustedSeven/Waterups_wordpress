...
<tr class="woocommerce-shipping-totals shipping">
    ...
    <td data-title="<?php echo esc_attr( $package_name ); ?>">
        ...
        elseif ( ! $has_calculated_shipping || ! $formatted_destination ) :
            if (is_cart()) esc_html_e( 'Shipping will be calculated at the checkout.', 'woocommerce' );//In order to proceed to checkout enter delivery address to  calculate shipping cost.
            else esc_html_e( 'Enter your address above to see available shipping options.', 'woocommerce' );//In order to proceed to checkout enter delivery address to  calculate shipping cost.
        elseif ( ! is_cart() ) :
        ...
        <?php if (( $has_calculated_shipping && $formatted_destination ) && $show_shipping_calculator ) : ?>
