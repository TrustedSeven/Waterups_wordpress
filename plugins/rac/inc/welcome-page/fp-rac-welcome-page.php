 ...
 */
?>
<div class=" fp-rac-welcome-page">
	<div class="fp-rac-welcome-header" > 
		<div class="fp-rac-welcome-title" >
			<h1>Welcome to <strong>Recover Abandoned Cart</strong></h1>
		</div>
		<div class="fp-rac-branding-logo" >
			<a href="http://fantasticplugins.com/" target="_blank" ><img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Fantastic-Plugins-final-Logo.png" alt="" /></a>
		</div>
	</div> 
	...
	<div class="fp-rac-welcomepage-tab">
		<ul>
			<li><a href="#fp-rac-tab-1" class="fp-rac-tab-1 fp-rac-tab fp-rac-active-welcome">About Recover Abandoned Cart</a></li>
			<!--            <li><a href="#compatibl plugins" class="tab_3">Compatible Plugins</a></li>-->
			<li><a href="#fp-rac-tab-2" class="fp-rac-tab-2 fp-rac-tab">Our Other Plugins</a></li> 
		</ul>        
		<a href="<?php echo esc_url(admin_url( 'edit.php?post_type=raccartlist&page=rac_settings' )) ; ?>" class="fp-rac-admin-btn" >Go to Settings</a>        
		<a href="http://fantasticplugins.com/support/" class="fp-rac-support-btn" target="_blank" >Contact Support</a>        
	</div>
	<!--            about Recover Abandoned Cart tab content      -->
	<div class="fp-rac-con-1 fp-rac-content" id="fp-rac-tab-1">
		<div class="fp-rac-section-1">
			<div class='fp-rac-section-a1'> 
	...
	<div class="fp-rac-con-2 fp-rac-content" id="fp-rac-tab-2">
		<div class="fp-rac-con2-title">
			<h2>Our Other WooCommerce Plugins</h2>
		</div>
		<div class="fp-rac-feature">
			<div class="fp-rac-two-fet-img">
				<a href="https://codecanyon.net/item/sumo-reward-points-woocommerce-reward-system/7791451?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Sumo_Reward_Points.png" alt=""/>
						<div class="fp-rac-hide">
							<h4>SUMO Reward Points</h4>
						</div>
						<div class="fp-rac-description-adv">
				...
				<a href="https://codecanyon.net/item/sumo-subscriptions-woocommerce-subscription-system/16486054?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Sumo_Subscription.png" alt=""/>
						<div class="fp-rac-hide">
			...
			<div class="fp-rac-two-fet-img">
				...
				<a href="https://codecanyon.net/item/galaxy-funder-woocommerce-crowdfunding-system/7360954?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Galaxy_Funder.png" alt=""/>
						<div class="fp-rac-hide">
							<h4>Galaxy Funder</h4>
						</div>
						<div class="fp-rac-description-adv">
				...
				<a href="https://codecanyon.net/item/universe-funder-woocommerce-crowdfunding-system/10283380?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Universe_Funder.png" alt=""/>
						<div class="fp-rac-hide">
		...
		<div class="fp-rac-feature">
			<div class="fp-rac-two-fet-img">
				<a href="https://codecanyon.net/item/woocommerce-pay-your-price/7000238?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Pay_Your_Price.png" alt=""/>
						<div class="fp-rac-hide">
				...
				<a href="https://codecanyon.net/item/woocommerce-paypal-adaptive-split-payment/7948397?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Paypal_Adaptive_Split_Payment.png" alt=""/>
						<div class="fp-rac-hide">
			...
			<div class="fp-rac-two-fet-img">
				...
				<a href="https://codecanyon.net/item/sumo-affiliates-woocommerce-affiliate-system/18273930?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Sumo_Affiliates.png" alt=""/>
						<div class="fp-rac-hide">
				...
				<a href="https://codecanyon.net/item/sumo-memberships-woocommerce-membership-system/16642362?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Sumo_Membership.png" alt=""/>
						<div class="fp-rac-hide">
		...
		<div class="fp-rac-feature">
			<div class="fp-rac-two-fet-img">
				<a href="https://codecanyon.net/item/sumo-donations-woocommerce-donation-system/12283878?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Sumo_Donation.png" alt=""/>
						<div class="fp-rac-hide">
				...
				<a href="https://codecanyon.net/item/sumo-discounts-advanced-pricing-woocommerce-discount-system/17116628?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Sumo_Discount.png" alt=""/>
						<div class="fp-rac-hide">
			...
			<div class="fp-rac-two-fet-img">
				<a href="https://codecanyon.net/item/sumo-coupons-woocommerce-coupon-system/16082070?ref=FantasticPlugins" target="_blank" >
					<div class="fp-rac-Brand-1">
						<img src="<?php echo esc_url( RAC_PLUGIN_URL ) ; ?>/assets/images/Sumo_Coupons.png" alt=""/>
						<div class="fp-rac-hide">
							<h4>SUMO Coupons</h4>
						</div>
						<div class="fp-rac-description-adv">
